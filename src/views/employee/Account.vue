        ...
        <operate>
          <div slot="left">
            <button class="white-button">
              <img class="button-icon-text" src="@/assets/common/qiyong.png">启用
            </button>
            <button class="white-button">
              <img class="button-icon-text" src="@/assets/common/jinyong.png">禁用
            </button>
          </div>
          <div slot="right">
            <input type="checkbox" class="check">包含下级组织
          </div>
        </operate>
