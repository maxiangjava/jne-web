      ...
      <div class="info">
        ...
        <el-form :model="form" :rules="rules" ref="form" label-width="120px" class="demo-form">
          ...
          <el-form-item label="工作单位" prop="orgIndex" required>
            <el-cascader v-model="form.orgIndex" :options="dptList" :props="dptListProps" style="width: 100%"></el-cascader>
          </el-form-item>
          <el-form-item label="管理单位" prop="manageOrg" required>
            <el-select v-model="form.manageOrg" placeholder="请选择管理单位" style="width: 100%">
              <el-option :label="item.value" :value="item.key" v-for="(item,index) in manageOrgDict" :key="index"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="身份类型" prop="statusKey" required>
            <el-cascader v-model="form.statusKey" :options="statusKeyList" :props="personKeyProps" style="width: 100%"></el-cascader>
          </el-form-item>
          <el-form-item label="可访问园区" prop="passSchoolArea" required>
            <el-cascader v-model="form.passSchoolArea" :options="regionList" :props="regionProps" style="width: 100%"></el-cascader>
          </el-form-item>
...
<!--          </el-form-item>-->
          ...
          <el-form-item label="民族">
            <el-select v-model="form.nation" placeholder="请选择民族" style="width: 100%">
              <el-option :label="item.value" :value="item.key" v-for="(item,index) in nationDict" :key="index"></el-option>
            </el-select>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    data(){
      return {
        nationDict:JSON.parse(sessionStorage.getItem('nation')),
        manageOrgDict:JSON.parse(sessionStorage.getItem('manageOrg')),
